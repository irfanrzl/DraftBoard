...
- IMPORTANT: "role" is ONLY ever one of: primary, created, updated, title. NEVER put a relationship type (like many-to-one) in "role". Relationship types belong ONLY in the "relations" array under "type".
- IMPORTANT: "type" is ONLY a data type (uuid, string, int, etc.), never a relationship.
